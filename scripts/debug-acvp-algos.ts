...
const main = async () => {
    try {
        ...
        const html = await fetchText('https://csrc.nist.gov/projects/cryptographic-algorithm-validation-program/validation-search');
        ...
        const relevant = allOptions.filter(opt => {
