...
- **Document Status**: New
- **Main Topic**: Brno University of Technology coordinates EU Horizon QARC project focusing on hybrid schemes, cryptographic agility, and real-world PQC deployment pilots across EU eGovernment and cloud infrastructures.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
- **Applicable Regions / Bodies**: Regions: European Union; Bodies: National Cyber Security Authorities (NCSAs)
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: Microsoft formally launches Quantum Safe Program (QSP) to build quantum-safe future across all products and services.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: Microsoft announces development of Majorana 1 quantum chip.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: PQShield launches UltraPQ-Suite collection of specialized PQC implementations including PQPlatform-TrustSys quantum-safe Root of Trust for ASIC/FPGA CNSA 2.0 compliance.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: Milestones: 2035: RSA phase-out
- **Applicable Regions / Bodies**: Regions: None detected; Bodies: NIST, NSA
- **Leaders Contributions Mentioned**: Ali El Kaafarani (Founder and CEO), Dr. Axel Poschmann (VP of Product)
- **PQC Products Mentioned**: PQMicroLib-Core, PQCryptoLib-Core
- **Protocols Covered**: None detected
- **Infrastructure Layers**: None detected
- **Standardization Bodies**: None detected
- **Compliance Frameworks Referenced**: None detected
...
- **Migration Timeline Info**: Milestones: 2035: PQC required for federal systems
- **Applicable Regions / Bodies**: Regions: United States; Bodies: NIST, IETF, NCSC, NEDO
- **Leaders Contributions Mentioned**: Shuichi Katsumata, Guilhem Niot, Thom Wiggers, Keitaro Hashimoto, Ben Marshall, Pierre-Yves Strub
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: PQShield partners with Carahsoft to make post-quantum cryptography solutions available to U.S. government agencies.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: Milestones: 2035: Transition to post-quantum cryptography by 2035
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: BIS publishes quantum-readiness roadmap for financial systems, aiming for critical systems to be quantum-safe by early 2030s.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: Shor's Algorithm, Harvest Now Decrypt Later
- **Migration Timeline Info**: Critical systems to be quantum-safe by early 2030s; transition should start immediately with awareness and inventory as foundations.
- **Applicable Regions / Bodies**: None detected
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
...
- **Migration Timeline Info**: Milestones: April 2026: Develop initial departmental PQC migration plan | End of 2031: Completion of PQC migration of high priority systems | End of 2035: Completion of PQC migration of remaining systems
- **Applicable Regions / Bodies**: Regions: Canada; Bodies: Canadian Centre for Cyber Security (CCCS), Treasury Board of Canada Secretariat (TBS), Shared Services Canada (SSC)
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: PKI, Key Management
...
- **Last Updated**: Not specified
- **Document Status**: Validated
- **Main Topic**: Security Policy Implementation Notice (SPIN) on PQC migration effective October 9, 2025 under Policy on Government Security.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: CRQC, Harvest Now Decrypt Later
- **Migration Timeline Info**: Milestones: 2026: Phase 1 preparation | 2027: Phase 2 identification | 2028: Phase 3 transition | 2031: complete high-priority systems | 2035: complete remaining systems
- **Applicable Regions / Bodies**: Regions: Canada; Bodies: Government of Canada, Cyber Centre, Shared Services Canada (SSC), Treasury Board of Canada Secretariat (TBS)
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: PKI, Key Management
- **Standardization Bodies**: Cyber Centre, CMVP
- **Compliance Frameworks Referenced**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: Validated
- **Main Topic**: CACR announces results of its post-quantum cryptography competition selecting initial algorithms (36 submissions).
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
...
- **Protocols Covered**: None detected
- **Infrastructure Layers**: None detected
- **Standardization Bodies**: Chinese Association for Cryptologic Research (CACR)
- **Compliance Frameworks Referenced**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: Validated
- **Main Topic**: China launches Next-Generation Commercial Cryptographic (NGCC) Algorithms Program for PQC standardization.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
- **Applicable Regions / Bodies**: Regions: China; Bodies: Institute of Commercial Cryptography Standards (ICCS), Chinese Cryptography Standardization Technical Committee
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: PKI, Key Management
- **Standardization Bodies**: Institute of Commercial Cryptography Standards (ICCS)
- **Compliance Frameworks Referenced**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: China Telecom launches world's first distributed cryptography system combining QKD and PQC.
- **PQC Algorithms Covered**: None detected
...
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: QKD, PQC, Application
- **Standardization Bodies**: None detected
- **Compliance Frameworks Referenced**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: Validated
- **Main Topic**: ENISA publishes Post-Quantum Cryptography: Integration Study examining technology landscape.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
- **Applicable Regions / Bodies**: Regions: European Union; Bodies: ENISA, EU authorities
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: Europol Quantum Safe Financial Forum publishes call to action. Notes 86% of executives unprepared.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: ECCG publishes Agreed Cryptographic Algorithms version 2 with PQC guidance.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: Harvest Now Decrypt Later, Shor's Algorithm
- **Migration Timeline Info**: Milestones: 2025: New software and firmware signatures, Web browsers, servers, cloud servers | 2026: Traditional networking equipment | 2027: New NSS, operating systems | 2030: Legacy systems unable to support CNSA 2.0 phased out | 2035: All NSS quantum-resistant
- **Applicable Regions / Bodies**: Regions: United States, Canada, European Union, United Kingdom, Australia, Japan; Bodies: CNSA, ENISA, NCSC, ASD,
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: Validated
- **Main Topic**: ANSSI publishes initial position paper on post-quantum cryptography transition, mandating hybrid approach.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: Validated
- **Main Topic**: ANSSI publishes follow-up position paper with updated guidance on hybridization requirements.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
- **Applicable Regions / Bodies**: Regions: France; Bodies: ANSSI
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: ANSSI publishes two market studies on PQC readiness among French cybersecurity ecosystem (developers and consultants).
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: store now, decrypt later; impact of quantum computers on public key cryptography
- **Migration Timeline Info**: None detected
- **Applicable Regions / Bodies**: Regions: France; Bodies: ANSSI
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: ANSSI updates cryptographic accreditation doctrine to include PQC evaluation requirements.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: Milestones: 2025: First PQC certifications issued | 2027: PQC integration required for certain product qualifications
- **Applicable Regions / Bodies**: Regions: France; Bodies: ANSSI, CEA-Leti (CESTI)
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: Smartcard MultiApp 5.2 Premium PQC (Thales), Microcontrôleur S3SSE2A (Samsung)
- **Protocols Covered**: None detected
- **Infrastructure Layers**: PKI, Key Management
- **Standardization Bodies**: ANSSI
- **Compliance Frameworks Referenced**: CC (Critères Communs)
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: ANSSI outlines post-quantum cryptographic migration guidelines and regulatory timelines for French federal systems.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: Shor's Algorithm, Harvest Now Decrypt Later
- **Migration Timeline Info**: Milestones: 2025: Complete inventory of cryptographic systems | 2030: PQC required for federal systems
- **Applicable Regions / Bodies**: Regions: France; Bodies: ANSSI
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: TLS 1.3, X.509
...
- **Last Updated**: Not specified
- **Document Status**: Validated
- **Main Topic**: EU Joint Statement on PQC transition initiated by BSI with 18 EU member states (later 21).
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
- **Applicable Regions / Bodies**: Regions: European Union; Bodies: BSI, EU Member States
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: Validated
- **Main Topic**: BSI publishes Version 2025-01 of TR-02102-1 with significant PQC recommendations including ML-KEM and ML-DSA.
- **PQC Algorithms Covered**: ML-KEM, ML-DSA
- **Quantum Threats Addressed**: Harvest Now Decrypt Later
- **Migration Timeline Info**: None detected
- **Applicable Regions / Bodies**: Regions: Germany; Bodies: BSI, European partner agencies
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: PKI, Key Management
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: BSI and DLR launch QUANTITY initiative in March 2025 focusing on quantum cryptanalysis to strengthen algorithm selection and validate PQC security.
- **PQC Algorithms Covered**: ML-KEM (formerly CRYSTALS-Kyber), FrodoKEM, Classic McEliece
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
- **Applicable Regions / Bodies**: Regions: Germany; Bodies: BSI (German Federal Office for Information Security), DLR (German Aerospace Center)
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: None detected
- **Standardization Bodies**: BSI, NIST
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: PQCC publishes comprehensive PQC Migration Roadmap in May 2025 with four-category framework: Preparation, Baseline Understanding, Planning and Execution, Monitoring and Evaluation.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: Validated
- **Main Topic**: Bank of Israel issues Directive Letter 202501EN (January 7, 2025) requiring financial institutions to manage quantum risk.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: Israel's National Digital Agency mandates government bodies to prepare for quantum computing threats and implement post-quantum encryption (PQC) by 2025.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: Harvest Now Decrypt Later, Shor's Algorithm, Interception of encrypted communications, Forging digital signatures, Compromising blockchain protections
- **Migration Timeline Info**: Milestones: 2025: Complete threat assessment and require PQC in new contracts
- **Applicable Regions / Bodies**: Regions: Israel; Bodies: National Digital Agency, Government ministries
- **Leaders Contributions Mentioned**: Ofra Frenkel (Israel’s chief government information officer at the National Digital Agency)
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: None detected
- **Standardization Bodies**: NIST (referenced for post-quantum algorithms)
- **Compliance Frameworks Referenced**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: Validated
- **Main Topic**: CRYPTREC publishes Guidelines for Post-Quantum Cryptography technical guidance.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: Validated
- **Main Topic**: NEDO K Program research on PQC implementation technologies. Final standardization documents due 2026.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: Milestones: 2024–2026: K Program research; 2026: Final standardization documents due
- **Applicable Regions / Bodies**: Regions: Japan; Bodies: NEDO, CRC, AIST, FFRI Security Inc, Preferred Networks Inc, Fujitsu, NTT, Mitsubishi Electronics, University of Tokyo, etc.
- **Leaders Contributions Mentioned**: Dr. Shuichi Katsumata (Lead Cryptography Researcher, PQShield), Dr. Ali El Kaafarani (CEO, PQShield), Tsutomu Matsumoto (AIST Fellow / Director of CPSEC)
- **PQC Products Mentioned**: PQMicroLib-Core, PQCryptoLib-Core, PQCryptoLib-SDK, PQPlatform-CoPro, PQPlatform-TrustSys, PQPerform-Flare, PQPerform-Inferno, PQPerform-Flex
- **Protocols Covered**: Ring signatures, threshold signatures, threshold encryption
- **Infrastructure Layers**: PKI, Key Management
- **Standardization Bodies**: NIST, IETF (Internet Engineering Task Force)
- **Compliance Frameworks Referenced**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: Japan's National Cyber Defense Push to prepare for quantum threats through post-quantum cryptographic (PQC) standards and infrastructure.
- **PQC Algorithms Covered**: CRYSTALS-Kyber, Dilithium (as part of NIST standardization process).
- **Quantum Threats Addressed**: Shor's Algorithm, Harvest Now Decrypt Later.
- **Migration Timeline Info**: None detected.
- **Applicable Regions / Bodies**: Regions: Japan; Bodies: METI, NISC, NICT.
...
- **Protocols Covered**: None detected.
- **Infrastructure Layers**: Key Management, Public Key Infrastructure (PKI).
- **Standardization Bodies**: NIST (referenced for PQC algorithm standardization).
- **Compliance Frameworks Referenced**: None detected.
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: NZISM v3.9 includes Section 2.4 on PQC preparation with 19 agencies implementing.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: November 2025: Release of NZISM v3.9 with PQC preparation section; 19 agencies implementing.
- **Applicable Regions / Bodies**: Regions: New Zealand; Bodies: 19 agencies (specific names not mentioned)
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: WPA3
- **Infrastructure Layers**: None detected
- **Standardization Bodies**: NIST
- **Compliance Frameworks Referenced**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: Korea Post-Quantum Cryptography Competition winners announced January 16, 2025.
- **PQC Algorithms Covered**: HAETAE, AIMer, SMAUG-T, NTRU+
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
- **Applicable Regions / Bodies**: Regions: South Korea; Bodies: KpqC (Korea Post-Quantum Cryptography Competition)
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: Validated
- **Main Topic**: NCSC publishes comprehensive three-phase PQC migration roadmap with specific milestones through 2035.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: New
- **Main Topic**: DSIT publishes Perspectives on the Plan for PQC Transition covering five CNI sectors.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: None detected
- **Applicable Regions / Bodies**: Regions: United Kingdom; Bodies: Department for Science, Innovation and Technology (DSIT), National Cyber Security Centre (NCSC)
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: Validated
- **Main Topic**: National Security Memorandum (NSM-10) on promoting U.S. leadership in quantum computing and mitigating risks from cryptanalytically relevant quantum computers (CRQCs).
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: CRQC, Harvest Now Decrypt Later, Shor's Algorithm
- **Migration Timeline Info**: Milestones: 2035: Mitigate quantum risk for federal systems | 2024: NIST standards for post-quantum cryptography
- **Applicable Regions / Bodies**: Regions: United States; Bodies: NIST, NSA
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
...
- **Last Updated**: Not specified
- **Document Status**: Validated
- **Main Topic**: NSA publishes Commercial National Security Algorithm Suite 2.0 with quantum-resistant algorithm requirements for National Security Systems.
- **PQC Algorithms Covered**: None detected
