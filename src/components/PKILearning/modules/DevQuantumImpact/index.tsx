...
export const DevQuantumImpactModule: React.FC = () => {
  ...
  const handleReset = () => {
    if (confirm('Restart Developer Quantum Impact module?')) {
      setCurrentPart(0)
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gradient">Developer Quantum Impact</h1>
          <p className="text-muted-foreground mt-2">
            Understand how the quantum threat impacts your code, libraries, and protocols &mdash;
