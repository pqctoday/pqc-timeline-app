...
export const PKIWorkshop: React.FC = () => {
    ...
    const handleReset = () => {
        if (confirm('Are you sure you want to reset the workshop? This will clear all generated keys and certificates.')) {
            resetProgress();
            resetStore();
            setCurrentStep(0);
        }
    ...
    const steps = React.useMemo(() => [
        ...
        },
        {
            ...
            component: <RootCAGenerator onComplete={() => markStepComplete('pki-workshop', 'root-ca')} />
        },
        {
            id: 'sign',
            ...
            <div className="mb-8">
                <div className="flex justify-between relative">
                    ...
                    {steps.map((step, idx) => (
                        ...
                        >
                            <div className={`w-10 h-10 rounded-full flex items-center justify-center border-2 transition-colors bg-background font-bold
                ${idx === currentStep
              ...
              `}>
                            ...
                            <span className="text-sm font-medium hidden md:block">{step.title.split(':')[1]}</span>
                        </button>
                    ))}
                </div>
            </div>
