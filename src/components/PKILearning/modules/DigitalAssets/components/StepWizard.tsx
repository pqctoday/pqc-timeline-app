    ...
    <div className="max-w-7xl mx-auto h-full">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
        ...
        <div className="flex flex-col space-y-6 min-w-0">
          <div className="bg-surface-800/50 border border-white/10 rounded-xl p-6 flex-1 flex flex-col min-w-0">
            ...
            {step.explanationTable ? (
              ...
              <div className="bg-muted/40 rounded-lg p-4 font-mono text-sm border border-white/5 mb-6 overflow-x-auto">
        ...
        <div className="flex flex-col space-y-6 min-w-0">
          <div className="bg-muted/30 border border-white/10 rounded-xl p-4 flex-1 flex flex-col font-mono text-sm relative overflow-hidden max-h-[600px] min-w-0">
