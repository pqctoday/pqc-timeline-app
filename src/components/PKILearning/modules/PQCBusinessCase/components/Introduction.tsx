  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <section className="glass-panel p-6">
        ...
        <div className="space-y-4 text-sm text-foreground/80">
          <p>
            ...
            organizational investment. A well-constructed business case translates technical risk
            into financial language that executives and boards understand.
          </p>
          <div className="bg-muted/50 rounded-lg p-4 border border-primary/20">
            <blockquote className="text-sm italic text-foreground/90">
              &ldquo;Organizations that delay PQC migration face compounding costs: rising
              compliance penalties, increasing breach exposure from harvest-now-decrypt-later
              attacks, and the growing technical debt of maintaining legacy cryptographic
              systems.&rdquo;
            </blockquote>
          ...
          <p>
            ...
            bridges the gap between technical teams who understand the urgency and decision-makers
            who control budgets.
          </p>
        </div>
      </section>
      ...
      <section className="glass-panel p-6">
        ...
        <div className="space-y-4 text-sm text-foreground/80">
          <p>
            Building a compelling case requires fluency in three financial frameworks that
            executives use to evaluate technology investments:
          </p>
        ...
        <div className="space-y-4 text-sm text-foreground/80">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-muted/50 rounded-lg p-4 border border-border flex flex-col">
              ...
              <ul className="text-xs text-muted-foreground space-y-1 flex-grow">
                <li>
                  &bull; <InlineTooltip term="Harvest Now, Decrypt Later">HNDL</InlineTooltip>{' '}
