      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[110] print:hidden"
          />
            ...
            >
              ...
              >
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  built to help professionals understand and prepare for the post-quantum
                  ...
                  <ul className="space-y-2.5 text-sm text-muted-foreground leading-relaxed">
                    <li className="flex items-start gap-2.5">
                      ...
                      <span>
                        This website has{' '}
                        <span className="font-medium text-foreground">
                          not received endorsement
                        </span>{' '}
                        from the organizations, standards bodies, or government agencies referenced
                        in its content
                      </span>
                    </li>
                    <li className="flex items-start gap-2.5">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  represent a cited organization, are a domain expert, or simply want to help
