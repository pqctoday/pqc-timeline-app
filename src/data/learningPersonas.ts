...
export const PERSONAS: Record<PersonaId, LearningPersona> = {
  ...
  ops: {
    ...
    quizDescription:
      'Test your knowledge on TLS operations, VPN/SSH configuration, PKI certificate management, KMS and HSM operations, standards bodies, and infrastructure migration planning.',
    quizCategories: [
      'pqc-fundamentals',
      'quantum-threats',
      'tls-basics',
