        ...
        <div className="space-y-6 max-w-[1400px] mx-auto animate-fade-in">
            ...
            <div className="flex flex-col gap-2">
                ...
                <p className="text-muted-foreground max-w-3xl">
                    Streamlined access to cryptographic module validations (FIPS 140-3), algorithm
                    validations (ACVP), and Common Criteria certifications, with a focus on Post-Quantum
