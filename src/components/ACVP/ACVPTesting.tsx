            ...
            for (const group of mlkemTestVectors.testGroups) {
                ...
                try {
                    ...
                    newResults.push({
                        ...
                        details: matches ? 'Recovered shared secret matches KAT' : 'Recovered shared secret mismatch'
                    });
                                ...
                                {results.length === 0 ? (
                                    ...
                                    results.map(res => (
                                        <tr key={res.id} className="hover:bg-white/5 transition-colors">
                                            ...
                                            <td className="p-3 text-muted truncate max-w-[200px]" title={res.details}>{res.details}</td>
                                        </tr>
                                    ))
                                )}
                            </tbody>
