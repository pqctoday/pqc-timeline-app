        ...
        <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
                ...
                <p className="text-muted max-w-2xl mx-auto">
                    Meet the visionaries and organizations driving the global transition to Post-Quantum Cryptography.
                </p>
            </div>
                        ...
                        {(leader.websiteUrl || leader.linkedinUrl) && (
                            <div className="flex gap-3 mt-auto pt-4 border-t border-white/5">
                                {leader.websiteUrl && (
                                    ...
                                    >
                                        <svg width="14" height="14" className="group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                ...
                                {leader.linkedinUrl && (
                                    ...
                                    >
                                        <svg width="14" height="14" className="group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
