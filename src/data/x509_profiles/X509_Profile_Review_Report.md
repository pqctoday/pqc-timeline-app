...
I reviewed 11 X.509 certificate and CSR profile CSV files against their respective standards and OpenSSL 3.5.4 compatibility. **4 issues were identified and corrected.**

| Status | Count |
|--------|-------|
| ✅ Profiles with no issues | 9 |
| 🔧 Profiles corrected | 2 |
| **Total files** | **11** |
...
| File | Scope | Status |
|------|-------|--------|
| Cert-Financial_ETSI_EN319412-2_2025.csv | End-Entity | ✅ Valid |
| Cert-RootCA-Financial_ETSI_EN319412-2_2025.csv | Root CA | ✅ Valid |
| CSR-Financial_ETSI_EN319412-2_2025.csv | CSR | ✅ Valid |
...
1. `Cert-GeneralIT_CABF_TLSBR_2025.csv` - **Modified**
2. `Cert-Telecom_3GPP_TS33310_2025.csv` - **Modified**
3. `Cert-Financial_ETSI_EN319412-2_2025.csv`
4. `Cert-GeneralIT_CABF_TLSBR_2025_PQC.csv`
5. `Cert-RootCA-Financial_ETSI_EN319412-2_2025.csv`
6. `Cert-RootCA-GeneralIT_CABF_TLSBR_2025.csv`
7. `Cert-RootCA-Telecom_3GPP_TS33310_2025.csv`
8. `Cert-Telecom_3GPP_TS33310_2025_PQC.csv`
9. `CSR-Financial_ETSI_EN319412-2_2025.csv`
10. `CSR-GeneralIT_CABF_TLSBR_2025.csv`
11. `CSR-Telecom_3GPP_TS33310_2025.csv`
