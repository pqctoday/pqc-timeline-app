...
export const DrbgArchitectureDemo: React.FC = () => {
  ...
  // SP 800-90A §8.6.3: nonce should be obtained from an external source.
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                <div>
                  ...
                  <label
                    ...
                    title="SP 800-90A §8.6.3: nonce should be obtained from an external source"
                  >
                    Custom nonce (hex, optional)
                  </label>
                  <Input
                    id="drbg-nonce"
                    placeholder="e.g. 0011aabb… (§8.6.3)"
                    value={nonceHex}
