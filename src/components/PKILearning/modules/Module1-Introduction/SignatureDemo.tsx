...
export const SignatureDemo: React.FC<SignatureDemoProps> = ({ onComplete }) => {
    ...
    const handleSign = async () => {
        ...
        try {
            ...
            const keyResult = await openSSLService.execute('openssl genpkey -algorithm ED25519 -out sign.key');
            ...
            const signCmd = 'openssl pkeyutl -sign -inkey sign.key -rawin -in message.txt -out signature.bin';
