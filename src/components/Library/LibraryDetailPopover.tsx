        ...
        >
            ...
            <div className="p-4 border-b border-white/10 bg-white/5 flex justify-between items-start gap-4">
                <div>
                    ...
                    <h3 id="popover-title" className="text-lg font-bold text-white leading-tight">{item.documentTitle}</h3>
                </div>
                <button
                    onClick={onClose}
            ...
            <div className="p-6 max-h-[70vh] overflow-y-auto space-y-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-300 leading-relaxed">{item.shortDescription || 'No description available.'}</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h4 className="text-xs font-semibold text-muted uppercase tracking-wider mb-1">Status</h4>
                            <p className="text-sm text-white">{item.documentStatus}</p>
                        </div>
                        <div>
                            <h4 className="text-xs font-semibold text-muted uppercase tracking-wider mb-1">Authors/Org</h4>
                    ...
                    <div className="space-y-6">
                        <div>
                            <h4 className="text-xs font-semibold text-muted uppercase tracking-wider mb-1">Initial Pub. Date</h4>
                        ...
                        <div>
                            <h4 className="text-xs font-semibold text-muted uppercase tracking-wider mb-1">Last Update</h4>
                            <div className="flex items-center gap-1.5 text-white text-sm">
                                <Calendar className="w-3 h-3 text-muted shrink-0" />
                    ...
                    <div className="space-y-6">
                        {item.regionScope && (
                            <div>
                                <h4 className="text-xs font-semibold text-muted uppercase tracking-wider mb-1">Region Scope</h4>
                                <p className="text-sm text-gray-300">{item.regionScope}</p>
                            </div>
                        )}
                        {item.migrationUrgency && (
                            <div>
                                <h4 className="text-xs font-semibold text-muted uppercase tracking-wider mb-1">Migration Urgency</h4>
                    ...
                    <div className="space-y-6">
                        {item.applicableIndustries && (
                            <div>
                                <h4 className="text-xs font-semibold text-muted uppercase tracking-wider mb-1">Applicable Industries</h4>
