  ...
  return async function (moduleArg = {}) {
    ...
    ;(function () {
      ...
      var currentSafariVersion =
        userAgent.includes('Safari/') && userAgent.match(/Version\/(\d+\.?\d*\.?\d*)/)
...
/** not-@type {!BigUint64Array} */
    ...
    function findWasmBinary() {
      return locateFile('openssl.wasm')
    }
    ...
    var _execute_tls_simulation = (Module['_execute_tls_simulation'] =
      makeInvalidEarlyAccess('_execute_tls_simulation'))
    ...
    function assignWasmExports(wasmExports) {
      ...
      assert(
        typeof wasmExports['execute_tls_simulation'] != 'undefined',
        'missing Wasm export: execute_tls_simulation'
      )
      assert(
      ...
      _execute_tls_simulation = Module['_execute_tls_simulation'] = createExportWrapper(
        'execute_tls_simulation',
        3
      )
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createOpenSSLModule
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createOpenSSLModule
} else if (typeof define === 'function' && define['amd']) define([], () => createOpenSSLModule)
