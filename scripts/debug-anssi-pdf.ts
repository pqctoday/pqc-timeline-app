...
const PRODUCT_PAGE =
  'https://cyber.gouv.fr/produits-certifies/multiapp-52-premium-pqc-gp-se-version-52'
...
async function debug() {
  ...
  let pdfUrl = allPdfLinks.find(
    (l) =>
      l.toLowerCase().includes('cible') ||
      l.toLowerCase().includes('security_target') ||
