...
export const AssessReport: React.FC<AssessReportProps> = ({ result }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto print:max-w-none">
      ...
      {/* Spacer table: invisible <thead>/<tfoot> repeat on every printed page,
          reserving space so content flows below the fixed header and above the fixed footer */}
      <table className="w-full print-report-table">
        <thead>
          <tr>
