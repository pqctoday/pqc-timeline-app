...
- **Audit Finding:** Line-by-line code review performed.
  ...
  - _Result:_ Zero gaps identified.
  ...
  - **NIAP / BSI / ANSSI:** Initial tests proved these sites are fragile (bot blocking/timeouts).
    - _Resolution:_ Shifted to **Scheme-Based Derivation**. Data for these agencies is now derived from the reliable Global CC CSV by filtering for `Scheme=US/DE/FR`.
    - _Result:_ 100% Data Availability without flaky scrapers.
