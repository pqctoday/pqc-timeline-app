...
export const KeyDetails: React.FC<KeyDetailsProps> = ({ selectedKey }) => {
    ...
    // Derived values
    const formattedRaw = React.useMemo(() => formatValue(selectedKey, rawValueMode), [selectedKey, rawValueMode]);
    const formattedPkcs8 = React.useMemo(() => formatPkcs8(selectedKey, pkcs8ValueMode), [selectedKey, pkcs8ValueMode]);
    ...
    const copyToClipboard = async (text: string, type: 'raw' | 'pkcs8') => {
        try {
            ...
            // Failed to copy to clipboard - ignore silently
        }
    };
            ...
            <div className="grid grid-cols-1 gap-6">
                ...
                <div className="space-y-2">
                    <div className="flex justify-between items-center">
                        <label htmlFor="raw-value-input" className="text-xs font-bold text-muted uppercase tracking-wider flex items-center gap-2">
                ...
                <div className="space-y-2">
                    <div className="flex justify-between items-center">
                        <label htmlFor="pkcs8-preview-input" className="text-xs font-bold text-muted uppercase tracking-wider flex items-center gap-2">
