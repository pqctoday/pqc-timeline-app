    ...
    const steps = [
        {
            ...
            component: (
                <div className="prose prose-invert max-w-none">
                    ...
                    <p>
                        PKI is the foundation of secure communication on the internet. It uses two keys:
                    </p>
                    <ul>
                        <li><strong>Public Key:</strong> Shared with everyone. Used to encrypt messages or verify signatures.</li>
                        <li><strong>Private Key:</strong> Kept secret. Used to decrypt messages or create signatures.</li>
                    </ul>
                    <p>
                        In this module, you will generate your own key pair and use it to sign a message.
                    </p>
                </div>
            )
        },
        {
            ...
            component: <KeyGenWorkshop
                onComplete={() => markStepComplete('module-1', 'keygen')}
            />
        },
        {
            id: 'signature',
            title: 'Demo: Digital Signatures',
            component: <SignatureDemo
                onComplete={() => markStepComplete('module-1', 'signature')}
            />
        }
    ];
            ...
            <div className="mb-8">
                <div className="flex justify-between relative">
                    ...
                    {steps.map((step, idx) => (
                        ...
                        >
                            <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 transition-colors bg-background
                ${idx === currentStep
