...
/** not-@type {!BigUint64Array} */
    ...
    var ccall = (ident, returnType, argTypes, args, opts) => {
      ...
      if (Asyncify.currData != previousAsync) {
        ...
        assert(
          ...
          'We cannot start an async operation when one is already in flight'
        )
        assert(
          !(previousAsync && !Asyncify.currData),
    ...
    function wasm_vpn_emit(type, payload) {
    ...
    var _wasm_vpn_pkcs11_probe = (Module['_wasm_vpn_pkcs11_probe'] =
      makeInvalidEarlyAccess('_wasm_vpn_pkcs11_probe'))
    var _wasm_vpn_list_pqc_mechanisms = (Module['_wasm_vpn_list_pqc_mechanisms'] =
      makeInvalidEarlyAccess('_wasm_vpn_list_pqc_mechanisms'))
    var _free = (Module['_free'] = makeInvalidEarlyAccess('_free'))
    var _wasm_vpn_ml_dsa_selftest = (Module['_wasm_vpn_ml_dsa_selftest'] = makeInvalidEarlyAccess(
      '_wasm_vpn_ml_dsa_selftest'
    ))
    var _wasm_vpn_ml_kem_selftest = (Module['_wasm_vpn_ml_kem_selftest'] = makeInvalidEarlyAccess(
      '_wasm_vpn_ml_kem_selftest'
    ))
    var _wasm_vpn_kem_alice_init = (Module['_wasm_vpn_kem_alice_init'] = makeInvalidEarlyAccess(
      '_wasm_vpn_kem_alice_init'
    ))
    var _wasm_vpn_kem_bob_encap = (Module['_wasm_vpn_kem_bob_encap'] =
      makeInvalidEarlyAccess('_wasm_vpn_kem_bob_encap'))
    var _wasm_vpn_kem_alice_decap = (Module['_wasm_vpn_kem_alice_decap'] = makeInvalidEarlyAccess(
      '_wasm_vpn_kem_alice_decap'
    ))
    var _wasm_vpn_kem_get_secret = (Module['_wasm_vpn_kem_get_secret'] = makeInvalidEarlyAccess(
      '_wasm_vpn_kem_get_secret'
    ))
    var _wasm_vpn_shutdown = (Module['_wasm_vpn_shutdown'] =
      makeInvalidEarlyAccess('_wasm_vpn_shutdown'))
    var _wasm_vpn_configure_json = (Module['_wasm_vpn_configure_json'] = makeInvalidEarlyAccess(
      '_wasm_vpn_configure_json'
    ))
    var _wasm_vpn_initiate = (Module['_wasm_vpn_initiate'] =
    ...
    function assignWasmExports(wasmExports) {
      assert(
        typeof wasmExports['wasm_vpn_boot'] != 'undefined',
        'missing Wasm export: wasm_vpn_boot'
      )
      assert(
        typeof wasmExports['wasm_vpn_pkcs11_probe'] != 'undefined',
        'missing Wasm export: wasm_vpn_pkcs11_probe'
      )
      assert(
        typeof wasmExports['wasm_vpn_list_pqc_mechanisms'] != 'undefined',
        'missing Wasm export: wasm_vpn_list_pqc_mechanisms'
      )
      assert(typeof wasmExports['free'] != 'undefined', 'missing Wasm export: free')
      assert(
        typeof wasmExports['wasm_vpn_ml_dsa_selftest'] != 'undefined',
        'missing Wasm export: wasm_vpn_ml_dsa_selftest'
      )
      assert(
        typeof wasmExports['wasm_vpn_ml_kem_selftest'] != 'undefined',
        'missing Wasm export: wasm_vpn_ml_kem_selftest'
      )
      assert(
        typeof wasmExports['wasm_vpn_kem_alice_init'] != 'undefined',
        'missing Wasm export: wasm_vpn_kem_alice_init'
      )
      assert(
        typeof wasmExports['wasm_vpn_kem_bob_encap'] != 'undefined',
        'missing Wasm export: wasm_vpn_kem_bob_encap'
      )
      assert(
        typeof wasmExports['wasm_vpn_kem_alice_decap'] != 'undefined',
        'missing Wasm export: wasm_vpn_kem_alice_decap'
      )
      assert(
        typeof wasmExports['wasm_vpn_kem_get_secret'] != 'undefined',
        'missing Wasm export: wasm_vpn_kem_get_secret'
      )
      assert(
        typeof wasmExports['wasm_vpn_shutdown'] != 'undefined',
        'missing Wasm export: wasm_vpn_shutdown'
      )
      assert(
        typeof wasmExports['wasm_vpn_configure_json'] != 'undefined',
        'missing Wasm export: wasm_vpn_configure_json'
      )
      assert(
        typeof wasmExports['wasm_vpn_initiate'] != 'undefined',
        'missing Wasm export: wasm_vpn_initiate'
      )
      assert(
        typeof wasmExports['wasm_vpn_get_result'] != 'undefined',
      ...
      assert(
        typeof wasmExports['dynCall_iiiiii'] != 'undefined',
        'missing Wasm export: dynCall_iiiiii'
      )
      assert(
      ...
      assert(
        typeof wasmExports['dynCall_viidi'] != 'undefined',
        'missing Wasm export: dynCall_viidi'
      )
      assert(
      ...
      assert(
        typeof wasmExports['dynCall_iiiiid'] != 'undefined',
        'missing Wasm export: dynCall_iiiiid'
      )
      assert(
      ...
      _wasm_vpn_pkcs11_probe = Module['_wasm_vpn_pkcs11_probe'] = createExportWrapper(
        'wasm_vpn_pkcs11_probe',
        0
      )
      _wasm_vpn_list_pqc_mechanisms = Module['_wasm_vpn_list_pqc_mechanisms'] = createExportWrapper(
        'wasm_vpn_list_pqc_mechanisms',
        0
      )
      _free = Module['_free'] = createExportWrapper('free', 1)
      _wasm_vpn_ml_dsa_selftest = Module['_wasm_vpn_ml_dsa_selftest'] = createExportWrapper(
        'wasm_vpn_ml_dsa_selftest',
        0
      )
      _wasm_vpn_ml_kem_selftest = Module['_wasm_vpn_ml_kem_selftest'] = createExportWrapper(
        'wasm_vpn_ml_kem_selftest',
        0
      )
      _wasm_vpn_kem_alice_init = Module['_wasm_vpn_kem_alice_init'] = createExportWrapper(
        'wasm_vpn_kem_alice_init',
        2
      )
      _wasm_vpn_kem_bob_encap = Module['_wasm_vpn_kem_bob_encap'] = createExportWrapper(
        'wasm_vpn_kem_bob_encap',
        4
      )
      _wasm_vpn_kem_alice_decap = Module['_wasm_vpn_kem_alice_decap'] = createExportWrapper(
        'wasm_vpn_kem_alice_decap',
        2
      )
      _wasm_vpn_kem_get_secret = Module['_wasm_vpn_kem_get_secret'] = createExportWrapper(
        'wasm_vpn_kem_get_secret',
        2
      )
      _wasm_vpn_shutdown = Module['_wasm_vpn_shutdown'] = createExportWrapper(
        'wasm_vpn_shutdown',
        0
      )
      _wasm_vpn_configure_json = Module['_wasm_vpn_configure_json'] = createExportWrapper(
        'wasm_vpn_configure_json',
        1
      )
      _wasm_vpn_initiate = Module['_wasm_vpn_initiate'] = createExportWrapper(
        'wasm_vpn_initiate',
        0
      )
      _wasm_vpn_get_result = Module['_wasm_vpn_get_result'] = createExportWrapper(
        'wasm_vpn_get_result',
        0
      )
...
} else if (typeof define === 'function' && define['amd']) define([], () => StrongswanV2)
